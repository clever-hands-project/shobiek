...
//
//     final producByIdrModel = producByIdrModelFromJson(jsonString);
...
ProducByIdrModel producByIdrModelFromJson(String str) => ProducByIdrModel.fromJson(json.decode(str));

String producByIdrModelToJson(ProducByIdrModel data) => json.encode(data.toJson());

class ProducByIdrModel {
    ProducByIdrModel({
    ...
    factory ProducByIdrModel.fromJson(Map<String, dynamic> json) => ProducByIdrModel(
        mainCode: json["mainCode"] == null ? null : json["mainCode"],
        code: json["code"] == null ? null : json["code"],
        data: json["data"] == null ? null : ProductByID.fromJson(json["data"]),
