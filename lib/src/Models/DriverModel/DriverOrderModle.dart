...
//
//     final driverOrderModle = driverOrderModleFromJson(jsonString);

import 'package:meta/meta.dart';
import 'dart:convert';

DriverOrderModle driverOrderModleFromJson(String str) => DriverOrderModle.fromJson(json.decode(str));

String driverOrderModleToJson(DriverOrderModle data) => json.encode(data.toJson());

class DriverOrderModle {
    DriverOrderModle({
    ...
    factory DriverOrderModle.fromJson(Map<String, dynamic> json) => DriverOrderModle(
        mainCode: json["mainCode"] == null ? null : json["mainCode"],
        code: json["code"] == null ? null : json["code"],
        data: json["data"] == null ? null : List<DriverOrder>.from(json["data"].map((x) => DriverOrder.fromJson(x))),
