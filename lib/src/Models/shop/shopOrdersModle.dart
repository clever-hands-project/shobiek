...
//
//     final shopOrdersModel = shopOrdersModelFromJson(jsonString);

import 'package:meta/meta.dart';
import 'dart:convert';

ShopOrdersModel shopOrdersModelFromJson(String str) => ShopOrdersModel.fromJson(json.decode(str));

String shopOrdersModelToJson(ShopOrdersModel data) => json.encode(data.toJson());
...
class ShopOrdersModel {
    ...
    int mainCode;
    int code;
    List<ShopOrders> data;
    List<Error> error;

    factory ShopOrdersModel.fromJson(Map<String, dynamic> json) => ShopOrdersModel(
        mainCode: json["mainCode"] == null ? null : json["mainCode"],
        code: json["code"] == null ? null : json["code"],
        data: json["data"] == null ? null : List<ShopOrders>.from(json["data"].map((x) => ShopOrders.fromJson(x))),
...
class ShopOrders {
    ...
    factory ShopOrders.fromJson(Map<String, dynamic> json) => ShopOrders(
