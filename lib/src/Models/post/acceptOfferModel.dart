...
//
//     final acceptOfferModel = acceptOfferModelFromJson(jsonString);

import 'dart:convert';

AcceptOfferModel acceptOfferModelFromJson(String str) =>
    AcceptOfferModel.fromJson(json.decode(str));

String acceptOfferModelToJson(AcceptOfferModel data) =>
